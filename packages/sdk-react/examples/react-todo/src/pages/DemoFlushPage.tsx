  ...
  return (
    <div>
      ...
      <p>
        ...
        Real-world use: at <code>beforeunload</code> / page navigation in critical-event apps so
        the last events aren't lost when the tab closes. The SDK already does its best to push
        on visibility change, but an explicit flush is the belt-and-braces option.
      </p>
      <div className="row">
