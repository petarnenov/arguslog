...
public interface OrgWriteRepository {
   ...
   * lower-case wire value from {@link org.arguslog.billing.PlanTier#dbValue()} — pass {@code
   * "free"} for first-time creators, or the creator's highest-active tier so new orgs inherit
   * existing paid coverage (GH #38). The renewal/billing identity is NOT inherited; the new org
