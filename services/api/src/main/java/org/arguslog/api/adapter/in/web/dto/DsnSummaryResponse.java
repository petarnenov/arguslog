...
/**
 * Listing-time view of a DSN — intentionally omits the full {@code dsn} string. The
 * full string is returned only at creation time (by {@link DsnResponse}); after that
 * the dashboard surfaces only metadata + a revoke action, mirroring how GitHub PATs
 * are shown.
 */
