 ...
 * Bitbucket / Gitea later is one new value here plus one new branches-client implementation; the DB
 * CHECK constraint, the wire DTOs, and the OpenAPI snapshot all pick up the new value automatically
 * because they read this enum.
 *
