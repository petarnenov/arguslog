 ...
 * @param model self-reported model id (e.g. {@code claude-opus-4-7}); stored alongside the body
 *     so a future „re-run with newer model" affordance can see what was used.
 */
